      ...
      <header className="App-header">
        <Container className="ContainerProduct">
          <Form fluid="true" className="Form-Product">
            <Row>
              ...
              >
                <button
                  ...
                  type="submit"
                  style={{ marginTop: "-45px", paddingTop: '1px', marginLeft: '10px'}}
                >
                  <BiLeftArrow />
                </button>
                <Image
            ...
            <h1 style={{ color: "#0d0d0d", textAlign: "left", marginLeft: '10px' }}>
            ...
            >
              <input
                type="text" name="text" className="inNombre"
              ...
              />
			  <Form.Label htmlFor="" className="user-label"><MdDriveFileRenameOutline/>Nombre</Form.Label>
            ...
            >
              ...
              />
			  <Form.Label htmlFor="" className="user-label"><MdOutlineDescription/>Descripcion</Form.Label>
            </Form.Group>
            ...
            >
              <input
                name="text" className="inNombre"
                type="number"
                min="1"
                pattern="^[0-9]+"
                {...register("cantidad", { required: true })}
              />
              <Form.Label htmlFor="" className="user-label"><FaSortAmountDownAlt/>Cantidad del Producto</Form.Label>
            </Form.Group>
            ...
            >
              ...
              />
              <Form.Label htmlFor="" className="user-label"><BsCalendarDay/> Limite de Dias</Form.Label>
            </Form.Group>
			...
			<GoLocation />Departamento de Venta:{" "}
            </Form.Label>
            <Form.Select
              className="input"
			  style={{border:'2px solid #E211CC', boxShadow: '0 0.4rem #dfd9d9', borderRadius: '12px',
			  height: '45px'}}
