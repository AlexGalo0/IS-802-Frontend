              ...
              <div className="spectsMedium2">
                ...
                {userAuth && (
                  <>
                    ...
                    <Modal show={showDenuncia} onHide={handleCerrarDenuncia} /* style={{border: "1px solid #75E8E5"}} */>
                      ...
                      <form onSubmit={handleSubmit(enviarDenuncia)} style={{display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '5px'}}>
                        <input type="text" {...register("denuncia")} className="inPrecio" style={{width: '350px'}}/>
                        <button type="submit" className='buttonProducto' style={{backgroundColor: '#365662', color: '#f7f7f7', marginRight: '10px', width: '100px'}}>
