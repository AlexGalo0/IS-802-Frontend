				...
				<aside className='text-center'>
					...
					>
						...
						<form onSubmit={handleSubmit(filtrarProductos)}>
							...
							{/* Calificacion */}
							<h5 className='py-3 cate'>Calificación</h5>
							{Array(5)
								.fill()
								.map((_, i) => {
									return (
										<div className='checkbox-apple' style={{ width: "auto" }}>
											...
											/>
											<label
												htmlFor={`calificacion${i}`}
												style={{ marginTop: "3px" }}
											></label>
											<p className='checkP'>{i + 1} Estrellas</p>
										</div>
									);
								})}
							<br />
							<h5 className='py-3 cate'>Mas populares</h5>
							<div className='checkbox-apple' style={{ width: "auto" }}>
								<input
									type='checkbox'
									{...register("masPopulares")}
									style={{ marginTop: "3px" }}
									className='yep'
									id='populares'
								/>
								<label htmlFor='populares' style={{ marginTop: "3px" }}></label>
								<p className='checkP'>Más populares</p>
							</div>
